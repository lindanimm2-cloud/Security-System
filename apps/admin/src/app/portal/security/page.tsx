...
const INSTRUMENTS = [
  ...
  { href: '/portal/security/permissions', code: 'C', title: 'Emergency permissions', body: 'Notifications, vibration, location, SOS and device capabilities.' },
  { href: '/portal/security/emergency-setup', code: 'C2', title: 'Emergency setup', body: 'Guided prompts for the fastest possible emergency response.' },
  { href: '/apps', code: 'C3', title: 'Get the 4DS app', body: 'Phone, tablet, watch, PWA, and Control Panel — compatible platforms only.' },
  { href: '/apps/compatibility', code: 'C4', title: 'Compatibility', body: 'What this device can and cannot do for emergency response.' },
