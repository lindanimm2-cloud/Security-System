    ...
    () => [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'permissions', label: 'Emergency permissions', icon: 'officers', href: '/portal/security/permissions', hint: 'Alerts, vibration, location' },
          { id: 'emergency-setup', label: 'Emergency setup', icon: 'devices', href: '/portal/security/emergency-setup', hint: 'Guided protection prompts' },
          { id: 'get-app', label: 'Get the 4DS app', icon: 'devices', href: '/apps', hint: 'Phone, watch, Control Panel' },
          { id: 'compatibility', label: 'Compatibility', icon: 'history', href: '/apps/compatibility', hint: 'What this device can do' },
